...
namespace WebTheory\Pathagist\Config;

use WebTheory\Pathagist\Composer\Package;
use WebTheory\Pathagist\Config\Serializer\Version1Serializer;
use WebTheory\Pathagist\Config\Serializer\Version2Serializer;
use WebTheory\Pathagist\Config\Serializer\VersionedSerializer;
use WebTheory\Pathagist\Interfaces\SerializerInterface;

class Config
{
    public const FILE = 'pathagist.json';
    ...
    public function __construct($file, SerializerInterface $serializer)
    {
        $this->file = $file;
